...
matplot(bev$trsnum$wl
        ...
        , lty = 1, type = "l"
        , xlab = lambda, ylab = "AU", main = "Spektren - Goecklinger Bier bei 800 rcf, 2 mm Pfadlaenge"
...
plot(bev$sub$DT0041_Goecklinger_800rcf$pca300500$calres$scores[ , PCx], bev$sub$DT0041_Goecklinger_800rcf$pca300500$calres$scores[ , PCy]
     ...
     , cex = 2
     , main = "PCA - Goecklinger Bier bei 800 rcf, 2 mm Pfadlaenge")
...
boxplot(bev$sub$DT0041_Goecklinger_800rcf$spc$X450 ~ bev$sub$DT0041_Goecklinger_800rcf$data$duration
        ...
        , main = "AU_450nm - Goecklinger Bier bei 800 rcf, 2 mm Pfadlaenge")
...
boxplot(bev$sub$DT0041_Goecklinger_800rcf$pca$calres$scores[ , 1] ~ bev$sub$DT0041_Goecklinger_800rcf$data$duration
        ...
        , main = "PC1 - Goecklinger Bier bei 800 rcf, 2 mm Pfadlaenge")
...
boxplot(bev$sub$DT0041_Goecklinger_800rcf$pca$calres$scores[ , 2] ~ bev$sub$DT0041_Goecklinger_800rcf$data$duration
        ...
        , main = "PC2 - Goecklinger Bier bei 800 rcf, 2 mm Pfadlaenge")
...
matplot(bev$trsnum$wl
        ...
        , lty = 1, type = "l"
        , xlab = lambda, ylab = "AU", main = "Spektren - Goecklinger Bier, 600 Sekunden, 2 mm Pfadlaenge"
...
plot(bev$sub$DT0041_Goecklinger_600s$pca300500$calres$scores[ , PCx], bev$sub$DT0041_Goecklinger_600s$pca300500$calres$scores[ , PCy]
     ...
     , cex = 2
     , main = "PCA - Goecklinger Bier, 600 Sekunden, 2 mm Pfadlaenge")
...
boxplot(bev$sub$DT0041_Goecklinger_600s$spc$X450 ~ bev$sub$DT0041_Goecklinger_600s$data$rcf
        ...
        , main = "AU_450nm - Goecklinger Bier 600 Sekunden, 2 mm Pfadlaenge")

boxplot(bev$sub$DT0041_Goecklinger_600s$pca$calres$scores[ , 1] ~ bev$sub$DT0041_Goecklinger_600s$data$rcf
        , col = bev$par$DT0041_Goecklinger_600s$colp, pch = 20
        , xlab = "Relative Zentrifugalkraft", ylab = "PC 1"
        , main = "PC1 - Goecklinger Bier 600 Sekunden, 2 mm Pfadlaenge")

boxplot(bev$sub$DT0041_Goecklinger_600s$pca$calres$scores[ , 2] ~ bev$sub$DT0041_Goecklinger_600s$data$rcf
        , col = bev$par$DT0041_Goecklinger_600s$colp, pch = 20
        , xlab = "Relative Zentrifugalkraft", ylab = "PC 2"
        , main = "PC2 - Goecklinger Bier 600 Sekunden, 2 mm Pfadlaenge")
...
matplot(bev$trsnum$wl
        ...
        , lty = 1, type = "l"
        , xlab = lambda, ylab = "AU", main = "Spektren - Goecklinger Bier bei 800 rcf, 0,3 mm Pfadlaenge"
...
plot(bev$sub$DT0001_Goecklinger_800rcf$pca200300$calres$scores[ , PCx], bev$sub$DT0001_Goecklinger_800rcf$pca200300$calres$scores[ , PCy]
     ...
     , cex = 2
     , main = "PCA - Goecklinger Bier bei 800 rcf, 0,3 mm Pfadlaenge")
...
boxplot(bev$sub$DT0001_Goecklinger_800rcf$spc$X450 ~ bev$sub$DT0001_Goecklinger_800rcf$data$duration
        ...
        , xlab = "Zentrifugationsdauer in Sekunden", ylab = "AU bei 450 nm"
        , main = "AU_450nm - Goecklinger Bier bei 800 rcf, 0,3 mm Pfadlaenge")

boxplot(bev$sub$DT0001_Goecklinger_800rcf$pca$calres$scores[ , 1] ~ bev$sub$DT0001_Goecklinger_800rcf$data$duration
        , col = bev$par$DT0001_Goecklinger_800rcf$colp, pch = 20
        , xlab = "Zentrifugationsdauer in Sekunden", ylab = "PC 1"
        , main = "PC1 - Goecklinger Bier bei 800 rcf, 0,3 mm Pfadlaenge")

boxplot(bev$sub$DT0001_Goecklinger_800rcf$pca$calres$scores[ , 2] ~ bev$sub$DT0001_Goecklinger_800rcf$data$duration
        , col = bev$par$DT0001_Goecklinger_800rcf$colp, pch = 20
        , xlab = "Zentrifugationsdauer in Sekunden", ylab = "PC 2"
        , main = "PC2 - Goecklinger Bier bei 800 rcf, 0,3 mm Pfadlaenge")
...
boxplot(bev$sub$DT0001_Goecklinger_600s$pca$calres$scores[ , 1] ~ bev$sub$DT0001_Goecklinger_600s$data$rcf
        , col = bev$par$DT0001_Goecklinger_600s$colp, pch = 20
        , xlab = "Relative Zentrifugalkraft", ylab = "PC 1"
        , main = "PC1 - Goecklinger Bier 600 Sekunden, 2 mm Pfadlaenge")

boxplot(bev$sub$DT0001_Goecklinger_600s$pca$calres$scores[ , 2] ~ bev$sub$DT0001_Goecklinger_600s$data$rcf
        , col = bev$par$DT0001_Goecklinger_600s$colp, pch = 20
        , xlab = "Relative Zentrifugalkraft", ylab = "PC 2"
        , main = "PC2 - Goecklinger Bier 600 Sekunden, 2 mm Pfadlaenge")
...
for(i in 1:4){
  ...
  legend("topright"
         ...
         , lwd = bev$par$DT0041_000rcf_800rcf_240s$lwd
